...
function summation(arrayParameter) {
  let accumulator = 0;
  for (let i = 0; i < arrayParameter.length; i ++){
    accumulator += arrayParameter[i];
  }
  return accumulator;
  }
 function reduce(arrayParameter) {
   const betterLoop = arrayParameter.reduce(function(accumulator,item) {
